...
const IndexStatusBadge = () => {
  ...
  return (
    <div className="inline-flex items-center space-x-2 text-xs text-[hsl(var(--text-tertiary))] bg-[hsl(var(--background-secondary))] px-3 py-1.5 rounded-md border border-[hsl(var(--border))]">
